-- Hardening: atomic delay/schedule claims, stuck-run reaper, workflow versions.

-- ─── Claim due delay pauses (FOR UPDATE SKIP LOCKED) ─────────────────────────
...
-- ─── Claim due schedules (bump last_scheduled_at atomically) ─────────────────
...
-- ─── Reap zombie "running" executions (Vercel timeout / hung agent) ──────────
